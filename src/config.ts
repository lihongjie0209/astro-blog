...
const BASE_URL = 'https://blog-lihongjie0209s-projects.vercel.app'
const SITE_INFO = {
  title: '李宏杰的博客',
  author: '李宏杰',
  language: 'zh-CN',
  description: '全栈开发者，专注于 Java、Rust、Python、TypeScript 技术栈，分享技术实践与心得。',
  startYear: 2024,
  endYear: new Date().getFullYear(),
  email: 'lihongjie0209@gmail.com',
  baseUrl: BASE_URL + '/',
...
const ASIDE_CARDS = {
  info: {
    ...
    descriptionLines: [
      "全栈开发者",
      "专注于 Java、Rust、Python、TypeScript",
    ]
  }
}
const NAV_ITEMS = [
